...
function generateTable(passengersInfo, hotelInfo, flightInfo, transportationInfo , passengerInfo, voucherNumber) {
  ...
  console.log(passengersInfo, hotelInfo, flightInfo, transportationInfo , passengerInfo)

  let businessTitle = "NAGORI TRAVER (PVT) LTD....!";
  let businessSlogan = "HAJJ & UMRAH SERVICES";
  // let voucherNumber = 123456789;

  // let passengerInfo = {
  //   guest : 'GUEST NAME : ' + 'Saeed Ahmed',
...
const tables = [
  {
      ...
      columns: ['S.No', 'NAME', 'GENDER', 'PASSPORT NO', 'VISA NO'],
      rows: [       
        [passengersInfo]
      ]
  },
